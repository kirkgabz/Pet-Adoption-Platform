...
urlpatterns = [
    ...
    path("pets/manage/", views.StaffPetManagementView.as_view(), name="staff-pet-list"),
    ...
    path("pets/<int:pk>/state/", views.update_pet_state, name="pet-state"),
    ...
    path("pets/<int:pk>/favorite/", views.toggle_favorite_pet, name="pet-favorite"),
    ...
    path("users/onboarding/", views.adopter_onboarding, name="adopter-onboarding"),
    path("users/profile/", views.adopter_profile, name="adopter-profile"),
